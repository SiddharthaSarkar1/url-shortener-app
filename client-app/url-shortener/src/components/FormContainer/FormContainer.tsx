    ...
    <div className="container mx-auto p-2">
      <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
        <div className="w-full h-full rounded-xl p-20 backdrop-brightness-50">
          ...
          <p className="text-white pb-2 text-center font-extralight">
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex">
              <div className="relative w-full">
                ...
                <button
                  type="submit"
                  className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-blue-700 rounded border border-blie-800 focus:ring-4 focus:outline-none focus:ring-blue"
                >
                  Shorten URL
                </button>
              </div>
